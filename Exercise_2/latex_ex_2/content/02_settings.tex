...
\newcommand{\secondauthorfirstname}{Manuela Maria }
\newcommand{\secondauthorlastname}{Raidl }

\newcommand{\doctitle}{Exercise 2}
...
Author={Camilo Tello Fachin and Manuela Maria Raidl},
Keywords={Concurrent Programs, }{Parallel Programming, }{Technical University Vienna, }{Winter Semester 22, }
{MSc Computational Science and Engineering, }{C-Language}
}}
